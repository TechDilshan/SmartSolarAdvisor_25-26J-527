  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="card-solar">
        <h4 className="text-sm font-medium text-muted-foreground mb-4">Monthly Energy Production — {systemKw} kW System</h4>
      ...
      {/* Monthly Irradiance & Energy trend — seasonal prediction */}
      <div className="card-solar">
        <h4 className="text-sm font-medium text-muted-foreground mb-4">Monthly Irradiance & Energy trend (seasonal prediction)</h4>
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tfoot>
            <tr className="border-t-2 border-border font-semibold">
              <td className="py-2.5 px-3 text-foreground">Summary ({chartData.length} months)</td>

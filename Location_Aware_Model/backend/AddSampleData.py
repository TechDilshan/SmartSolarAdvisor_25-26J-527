...
if not firebase_admin._apps:
    firebase_admin.initialize_app(
        cred,
        {"databaseURL": os.getenv("FIREBASE_DB_URL", "https://project12-f6813-default-rtdb.firebaseio.com")}
    )
...
def generate_prediction_data(timestamp_dt, lux, temp, humidity, dust, previous_kwh=None):
    ...
    prediction_data = {
        ...
        "temperature": temp,
        "panel_area_m2": 25,
        "predicted_kwh_per5min": predicted_kwh,
        "longitude": 80.0018290988119,
        "latitude": 6.934817862744289
    }
...
def add_sample_data():
    ...
    start_date = datetime(2026, 1, 15, 6, 0, 0)
    end_date = datetime(2026, 2, 14, 18, 0, 0)
    ...
    while current_date <= end_date:
        ...
        while current_time <= day_end:
            _, current_values = generate_device_data(current_time, previous_values)

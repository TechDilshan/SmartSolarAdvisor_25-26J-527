        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl shadow-md p-6 text-white">
            ...
            <div className="text-sm opacity-90">Daily Yield (kWh)</div>
              ...
              <div className={`rounded-xl shadow-md p-6 text-white ${summary.faultDevices > 0
  ...
  return (
    <div className="border border-slate-200 rounded-lg p-4 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between mb-3">
        ...
        <span className={`px-2 py-1 rounded text-xs font-semibold ${device.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
          }`}>
          {device.status}
        </span>
      </div>
      ...
      {device.latestData && (
        <div className="space-y-2">
          ...
          {faultStatus && (
            <div className={`mt-2 p-2 rounded text-xs ${faultStatus.faultDetected
